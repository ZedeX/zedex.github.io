...
summary: |-
  ...
  ![Offline Explorer Doomed](offline-explorer-doomed.png)Offline Explorer Meet Errors When Dumping HTML5 Sites
title: HTML5 Makes Offline Browsing Doomed
---
For most [offline browsing software](http://en.wikipedia.org/wiki/Online_and_offline#Offline_browsing) (such as: Webzip, Offline Explorer), they could only grab the web by the source code which html file offers. Once they face JavaScript, they will doomed.

![Offline Explorer Doomed](offline-explorer-doomed.png)  
...
What's the substitution? HTML5 [Local Storage](http://dev.w3.org/html5/webstorage/) might be the one. Since HTML5 is based and explained by the browser itself. And Local Storage could save a lot data in it. So there's no need to decode JavaScript but just run them once and see what the results are, and keep them in reserve.
