...
[维基百科](http://en.wikipedia.org/wiki/E_(mathematical_constant)) 说：

> "e是自然对数的底数。"

但是，你去看 ["自然对数"](http://en.wikipedia.org/wiki/Natural_logarithm)，得到的解释却是：
...
昨天我读到一篇 [好文章](http://betterexplained.com/articles/an-intuitive-guide-to-exponential-functions-e/)，它把这个问题解释得非常清楚，而且一看就懂。
...
![](/wp-content/uploads/2020/11/chart01.png)

上式中的x就表示天数。这种生物在x天的总数，就是2的x次方。这个式子可以被改成下面这样：

![](/wp-content/uploads/2020/11/chart02.png)
...
![](/wp-content/uploads/2020/11/chart07.png)

回答就是271.828元，等于100个e。

但是，实际生活中，银行的利息没有这么高，如果利息率只有5%，那么100元存一年可以拿到多少钱呢？

![](/wp-content/uploads/2020/11/chart08.png)

为了便于思考，我们取n等于50：

![](/wp-content/uploads/2020/11/chart09.png)

我们知道，在100%利息率的情况下，n=1000所得到的值非常接近e：

![](/wp-content/uploads/2020/11/chart10.png)

因此，5%利息率就相当于e的20分之一次方：

![](/wp-content/uploads/2020/11/chart11.png)

20分之一正好等于5%的利率率，所以我们可以把公式改写成：

![](/wp-content/uploads/2020/11/chart12.png)
...
![](/wp-content/uploads/2020/11/chart13.png)

在时间t的情况下，通用公式就是：

![](/wp-content/uploads/2020/11/chart14.png)
...
![](/wp-content/uploads/2020/11/chart15.png)

计算结果是13.86年：

![](/wp-content/uploads/2020/11/chart16.png)

上式最后一个等号，表明用72除以增长率，可以得到翻倍的大致时间，这就是 [72法则](http://zh.wikipedia.org/wiki/72%E6%B3%95%E5%89%87) 的来源。
